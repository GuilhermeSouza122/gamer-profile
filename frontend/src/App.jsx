...
function App() {
  ...
  return <main className="app-shell">
    <header className="topbar"><div className="brand"><span className="brand-mark">GP</span><span>GAMER PROFILE</span></div><div className="status"><span className="pulse" /> STEAM CONNECTED</div></header>
