...
ALTER TABLE app_users ADD COLUMN IF NOT EXISTS xp_points INTEGER NOT NULL DEFAULT 0;
ALTER TABLE app_users ADD COLUMN IF NOT EXISTS level INTEGER NOT NULL DEFAULT 1;
